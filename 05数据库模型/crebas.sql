...
create table Institution (
   InstitutionsId       int                  not null,
   name                 nvchar               null,
   location             text                 null,
   master               nvarchar(64)         null,
   createDate           datetime             null,
   createBy             nvarchar(64)         null,
   modifyDate           datetime             null,
   modifyBy             nvarchar(64)         null,
   type                 nvarchar(256)        null,
   constraint PK_INSTITUTION primary key (InstitutionsId)
)
go
...
create table UserInfo (
   ...
   UserSchool           nvarchar(256)        null,
   UserCollege          nvarchar(256)        null,
   Userspecialty        nvarchar(256)        null,
   CreateDate           datetime             null,
   CreateBy             nvarchar(64)         null,
   ModifyDate           datetime             null,
   ModifyBy             nvarchar(64)         null,
...
create table loginInfo (
   UserId               int                  null,
   id                   int                  null,
   account              nvarchar(11)         null,
   loginDate            datetime             null,
   loginWay             nvarchar(8)          null,
...
alter table CourseInfo
   add constraint FK_COURSEIN_REFERENCE_DEPARTME foreign key (DepartmentId)
...
alter table department
   add constraint FK_DEPARTME_REFERENCE_INSTITUT foreign key (InstitutionsId)
      references Institution (InstitutionsId)
go
...
alter table menu
   add constraint FK_MENU_REFERENCE_MENU foreign key (men_MenuId2)
      references menu (MenuId)
go
