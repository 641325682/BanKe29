...
<script>
    ...
    export default {
        ...
        methods: {
            submitEdit () {
                var _this=this;
                _this.$axios.get('http://www.xhw8888.com/index/app/editDicSubmit?id='+_this.editId+"&region="+this.form.region+"&name="+this.form.data)
            ...
            handleEdit: function (index, row) {
                this.getDictypess()
                var _this=this;
                this.$axios.get('http://www.xhw8888.com/index/app/editDic?id='+index)
                    .then(function (response) {
            ...
            handleDel: function (index, row) {
				...
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					this.$axios.get('http://www.xhw8888.com/index/app/deledic?id='+index)
					    .then(function (response) {
            ...
            submit () {
                var vm = this
                if(this.form.data == '' || this.form.region == ''){
                    this.$message({
