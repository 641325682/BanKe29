	...
	export default {
		...
		methods: {
			...
			getUsers() {
				...
				this.$axios.get('http://47.113.124.225:8083//Teacher/Page',{params:{indexpage:para.indexpage,everypage:para.everypage}})
			...
			findUser() {
				...
				this.listLoading = true;  //获取数据成功
				var second_this = this;
				this.$axios.get('http://www.xhw8888.com/index/app/searchUser?name='+para.name)
				.then(function (response) {
					second_this.users = response.data
				})
				.catch(function (error) {
...
if(this.addForm.stno == '' || this.addForm.password == '' || this.addForm.name == '' || this.addForm.tel== ''
 || this.addForm.academy== ''||this.addForm.major == ''|| this.addForm.xuexiao== ''||this.addForm.xueli== ''
 ||this.addForm.sex== ''){
                    this.$message({
