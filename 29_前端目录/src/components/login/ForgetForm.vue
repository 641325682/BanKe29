	...
	<div>
		...
		<el-form class="login-form" autoComplete="on" ref="forgetForm" :model="forgetForm" :rules="forgetFormRules">
			...
			<el-form-item prop="email">
				...
				<!-- <clock-click-button type="plain" style="float: right;width: 35%" text="发送验证码" after-text="重新发送" :on-click="sendEmailCode">
				</clock-click-button> -->
				<button type="plain" style="float: right;width: 35%" text="发送验证码" after-text="重新发送" :on-click="sendEmailCode">
				</button>
			</el-form-item>
