...
<div >
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" style="margin-left: 66%;" label-width="0px" class="demo-ruleForm login-container">
      ...
      handleSubmit2(ev) {    //这是提交的数据
        ...
        this.$refs.ruleForm2.validate((valid) => {
          if (valid) {
			...
			this.$axios.post('http://47.113.124.225:8083/supperlogin',data)
